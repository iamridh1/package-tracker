		...
		<div className="container">
			...
			<section className="section">
				...
				<div className="section-body">
					<h2 className="section-title">Add UPS tracking label</h2>
									...
									<form id="add-track" onSubmit={handleSubmit}>
										...
										<div className="form-group">
											...
											<div>
												...
												<div className="form-check form-check-inline">
													<input className="form-check-input" type="radio" id="first" value="first" 
													name="type" onChange={handleTypeChange} checked={type === 'first'} />
													<label className="form-check-label" htmlFor="first">First Class</label>
												</div>
												<div className="form-check form-check-inline">
